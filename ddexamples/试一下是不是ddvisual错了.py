...
#     # dist = np.exp(-dist) 
#     max_dist = 5.0
#     dist = 1.0 - (np.clip(dist, 0, max_dist) / max_dist)
#     angle = np.angle(z)
...
# # ================= 配置区域 =================
# # 请确保这里指向你训练好的模型文件夹
# LOG_DIR = './runs/PPOLag-{SafetyPointGoal1-v0}/seed-000-2026-02-26-19-29-59'
...
#         evaluator.load_saved(save_dir=LOG_DIR, model_name='epoch-400.pt', camera_name=CAMERA_NAME)
...
#                 # 可视化使用确定性策略
#                 act = actor.predict(obs_t, deterministic=False)
...
# ================= 配置区域 =================
# 请确保这里指向你训练好的模型文件夹
LOG_DIR = './runs/PPOLag-{SafetyPointGoal1-v0}/seed-000-2026-02-27-18-28-38'
# runs/PPOLag-{SafetyPointGoal1-v0}/seed-000-2026-02-07-19-09-38
VIDEO_FILENAME = "safe_navigation_26dim.mp4"
MAX_STEPS = 2000  
CAMERA_NAME = 'fixedfar' 
